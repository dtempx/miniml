...
**What is this for?** MiniML basically enables *AI-powered Conversational Analytics* (aka *text-to-SQL* or *chat-with-your-data*). You define your data once in a simple YAML model (or semantic layer), and MiniML a safe, structured vocabulary of dimensions and measures to work with to your AI/agentic layer. Instead of letting an LLM write raw SQL against your raw tables, which can be error-prone and risky, the AI picks from your well-defined model, and MiniML generates correct, optimized SQL for you. The result: users can ask questions in plain English like *"What were total sales by store last month?"* and get accurate, repeatible answers from your database.
